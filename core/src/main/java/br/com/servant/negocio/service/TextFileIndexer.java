...
public class TextFileIndexer {
	...
	public void testeIndexDocumento() throws IOException{
		Document doc = new Document();
		...
		doc.add(new LongField("id", new Date().getTime(), Field.Store.YES));
		doc.add(new StringField("nome", "mario", Field.Store.YES));
		doc.add(new StringField("sobrenome", "melo", Field.Store.YES));
